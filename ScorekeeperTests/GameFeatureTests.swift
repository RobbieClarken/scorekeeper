...
struct GameFeatureTests {
    ...
    @Test(
        ...
        expectNoDifference(
            model.rows,
            [
                GameModel.Row(player: Player(id: UUID(2), gameID: UUID(1), name: "P2", score: 3)),
                GameModel.Row(player: Player(id: UUID(3), gameID: UUID(1), name: "P3", score: 2)),
                GameModel.Row(player: Player(id: UUID(1), gameID: UUID(1), name: "P1", score: 1)),
            ]
        )
    }
